...
struct NotificationSettingsView: View {
    ...
    @AppStorage(NotificationPreference.likes)     private var likes = true
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    if isInstructor {
                        ...
                        toggle("Likes on your posts", "heart.fill", $likes, id: "notifications.likes")
                    }
            ...
            .onChange(of: [bookings, messages, reviews, community, events, likes, reminders, coverage, presence]) { apply() }
        }
    }
